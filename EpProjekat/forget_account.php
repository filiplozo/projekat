...
<div class="container-fluid"id="primary"> <!-- Primary Id-->
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                <h1 style="margin-top:50px;padding-top:50px;">Forgot Your Account?</h1><hr>
                <?php echo  @$error; ?>
                <p class="text-center">Please Enter your Email or Phone Number to Find Your Account.</p><br><br>
                <form method="post">
                    <div class="form-group">
                        <input type="Email" name="email" class="form-control" id="#"placeholder="Email or Phone Number"required>
                    </div><hr>

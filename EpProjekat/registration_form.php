...
?>
<div class="container-fluid"style="background-color:#ffffff;color:#000;"> <!-- Primary Id-->
    <div class="container">
        <div class="row">
            <center><h1 style="background-color:yellow; border-radius:50px;display:inline-block;"><b>Create New Account</b></h1></center>
            <?php echo @$msg;?><br>
